...
public class ShotgunScript : MonoBehaviour
{
    ...
    {
        //muzzleFlash.Play();
        GameObject shellCopy = Instantiate<GameObject>(shell, shellSpawnPos.position, transform.rotation) as GameObject;
        ...
        {
            GameObject bulletCopy = Instantiate(shotgunBullet, bulletSpawnPos.position, transform.rotation) as GameObject;
        }
